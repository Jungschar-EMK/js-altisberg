...
export default class BaseServie {
    ...
    protected async delete_request(url: string, config: AxiosRequestConfig = this.deleteConfig) {
    ...
    protected async get_request(url: string, config: AxiosRequestConfig = this.getConfig) {
        const encodedUrl = encodeURI(url);
        console.info('API Call:=', url);
    ...
    protected async post_request(url: string, data: any, config: AxiosRequestConfig = this.postConfig) {
        const encodedUrl = encodeURI(url);
    ...
    protected async put_request(url: string, data: any, config: AxiosRequestConfig = this.putConfig) {
        const encodedUrl = encodeURI(url);
        console.info('API Call:=', url, 'data', data);
        try {
